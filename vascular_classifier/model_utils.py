...
#Loading the model, scaler, and features list and finding the files' directories.
_pkg_root = os.path.dirname(__file__)

#Building paths to the assets.
_model_path  = os.path.join(_pkg_root, "assets", "xgb_model.pkl")
_scaler_path = os.path.join(_pkg_root, "assets", "scaler.pkl")

#Load the model, scaler, and trained feature list.
